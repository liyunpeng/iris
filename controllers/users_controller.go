...
// }
//否则只返回数据模型
func (c *UsersController) Get() (results []datamodels2.User) {
...
func (c *UsersController) GetBy(id int64) (user datamodels2.User, found bool) {
...
func (c *UsersController) PutBy(id int64) (datamodels2.User, error) {
